...
public class PtrFrameLayout extends ViewGroup {
    ...
    private CustomFunctionViewHandler customFunctionViewHandler = new CustomFunctionViewHandler();
    ...
    public void setLoadMoreEnable(boolean loadMoreEnable) {
        ...
        if (!hasInitLoadMoreView && isLoadMoreEnable) {
            ...
            } else if(mContentView instanceof FunctionalRecyclerView) {
                hasInitLoadMoreView = customFunctionViewHandler.handleSetAdapter(mContentView, mLoadMoreView,
                        onClickLoadMoreListener);
                customFunctionViewHandler.setOnScrollBottomListener(mContentView, onScrollBottomListener);
            }
        }
    }
