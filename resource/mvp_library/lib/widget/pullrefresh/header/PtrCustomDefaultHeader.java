...
public class PtrCustomDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    public PtrCustomDefaultHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public PtrCustomDefaultHeader(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.ptr_default_header, this);
