...
public class BallView extends View {
    ...
    private void initBallPathAnimator(Path path) {
        ...
        ballPathAnimator.setBallPathAnimatorListener(new AnimatorListener(this));
    ...
    private static class AnimatorListener implements AbstractBallAnimator.BallAnimatorListener {
